...
### Chamando o dss file ###
file_dss = os.path.join(os.path.dirname(__file__), 'dssfiles/circbtfull_storage.dss')
file_dss_loadshapes = os.path.join(os.path.dirname(__file__), 'dssfiles/loadshapes.dss')
...
##### Dando Solve no circuito (sem baterias)
dss.solution.solve()
...
####################################################
## Criando um dataframe com as tensões nos postes ##
####################################################
